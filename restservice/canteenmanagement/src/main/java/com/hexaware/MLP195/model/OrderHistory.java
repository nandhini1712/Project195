 ...
 */
  public OrderHistory(final int argOrdCusId, final int argOrdOrdId,
      final String argOrdDetails, final String argOrdPayment,
       final String argOrdStatus, final float argTotCost) {
  ...
  public final boolean equals(final Object obj) {
    ...
    if (Objects.equals(ordcusId, ordh.ordcusId)
        || Objects.equals(ordordId, ordh.ordordId)
        || Objects.equals(ordDetails, ordh.ordDetails)
        || Objects.equals(ordPayment, ordh.ordPayment) || Objects.equals(ordStatus, ordh.ordStatus)
        || Objects.equals(totCost, ordh.totCost)) {
      return true;
    }
    return false;
  }
  ...
  public final int getOrdCusId() {
    ...
    */
  public final void setOrdCusId(final int  argOrdCusId) {
    this.ordcusId = argOrdCusId;
  }
    /**
  ...
  public final int getOrdOrdId() {
     ...
     */
  public final void setOrdOrdId(final int argOrdOrdId) {
    this.ordordId = argOrdOrdId;
  }
    /**
  ...
  public final String getOrdDetails() {
     ...
     */
  public final void setOrdDetails(final String  argOrdDetails) {
    this.ordDetails = argOrdDetails;
  }
    /**
  ...
  public final String getOrdPayment() {
     ...
     */
  public final void setOrdPayment(final String  argOrdPayment) {
    this.ordPayment = argOrdPayment;
  }
    /**
     * @return this order details.
  ...
  public final float getTotCost() {
    ...
    */
  public final void setOrdStatus(final Float  argTotCost) {
    this.totCost = argTotCost;
  }
    /**
    ...
    */
  public final void setCustId(final int argOrdOrdId, final int argOrdCusId,
      final String argOrdDetails, final String argOrdPayment,
      final String argOrdStatus, final float argTotCost) {
    this.ordcusId = argOrdCusId;
    this.ordordId = argOrdOrdId;
